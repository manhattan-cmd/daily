  ...
  return (
    <div className="animate-in mb-3 flex items-start gap-2.5 rounded-xl border border-border bg-white/[0.03] px-3 py-2.5">
      ...
      <p className="min-w-0 flex-1 text-[11px] leading-relaxed text-muted-foreground">
        Bu kategoriler <span className="text-foreground">örnek</span> — içlerine
        gir, alt kategorileri ve özelliklerini gör. İşine yaramayanı sil,
        istediğini yeniden adlandır.
      </p>
      <button
        type="button"
        onClick={dismiss}
