...
export const en = {
  ...
  "features.builtInSection": "Built-in features",
  "features.yours": "Your features",
  ...
  "features.builtInHint": "Built-in feature — the name is fixed, how it is measured can change",
  ...
  "features.createHint": "Added to the pool; attach it to categories from Structure or straight from the entry form.",
  ...
  "measure.scale": "Scale",
  "measure.scaleHint": "Scores are averaged, never summed — five sleep scores make an average, not a total.",
  ...
  "measure.unit": "Unit",
  "measure.unitPlaceholder": "kg, min, ₺…",
  ...
  "features.namePlaceholder": "e.g. Walking duration",
...
export const tr: Record<MessageKey, string> = {
  ...
  "features.builtInSection": "Yerleşik özellikler",
  "features.yours": "Kendi özelliklerin",
  "features.notUsedYet": "henüz kullanılmadı",
  "features.blurb": "Ağırlık, süre, para… kategorilere tak, girdi girerken değerini doldur.",
  "features.builtInHint": "Yerleşik özellik — adı sabit, nasıl ölçüldüğü değişebilir",
  ...
  "features.createHint": "Havuza eklenir; kategorilere Yapı sayfasından ya da girdi formundan bağlanır.",
  ...
  "measure.scale": "Skala",
  "measure.scaleHint": "Puanlar toplanmaz, ortalanır — beş günün uyku puanı ortalama verir, toplam değil.",
  ...
  "features.namePlaceholder": "örn. Yürüyüş süresi",
